...
# tool の columns label 生成時に参照する。未掲載のメトリクスは title-case フォールバック。
_SEMANTIC_METRIC_DISPLAY_NAMES: Dict[str, str] = {
    # batter_season（Statcast）
    "batting_average": "AVG",
    "on_base_pct": "OBP",
    "slugging_pct": "SLG",
    "ops_metric": "OPS",
    "weighted_on_base_avg": "wOBA",
    "weighted_runs_created_plus": "wRC+",
    "hard_hit_rate": "HardHit%",
    "barrel_rate": "Barrel%",
    "hits_total": "H",
    "at_bats_total": "AB",
    "plate_appearances_total": "PA",
    "home_runs_total": "HR",
    "walks_total": "BB",
    "strikeouts_total": "SO",
    "runs_batted_in_total": "RBI",
    "risp_batting_average_season": "AVG (RISP)",
    # batter_clutch
    "clutch_woba": "Clutch wOBA",
    "clutch_xwoba": "Clutch xwOBA",
    "clutch_ops": "Clutch OPS",
    "clutch_batting_average": "Clutch AVG",
    "clutch_hard_hit_rate": "Clutch HardHit%",
    "clutch_barrel_rate": "Clutch Barrel%",
    "risp_batting_average": "AVG (RISP)",
    "risp_woba": "wOBA (RISP)",
    "risp_strikeout_rate": "K% (RISP)",
    "bases_loaded_batting_average": "AVG (Bases Loaded)",
    "bases_loaded_woba": "wOBA (Bases Loaded)",
    # batter_monthly
    "monthly_batting_average": "AVG (Monthly)",
    "monthly_ops": "OPS (Monthly)",
    "monthly_home_runs": "HR (Monthly)",
    # pitcher_*
    "era_by_inning": "ERA by Inning",
    "era_first_inning": "1st Inning ERA",
    "era_vs_lhb": "ERA vs LHB",
    "era_vs_rhb": "ERA vs RHB",
    "pitcher_risp_xwoba": "xwOBA (RISP)",
    "pitcher_non_risp_xwoba": "xwOBA (non-RISP)",
    "pitcher_risp_k_pct": "K% (RISP)",
    "pitcher_risp_baa": "BAA (RISP)",
    # batter_season_legacy (FanGraphs)
    "fg_woba": "wOBA",
    "fg_xwoba": "xwOBA",
    "fg_wrc_plus": "wRC+",
    "fg_war": "WAR",
    "fg_ops": "OPS",
    "fg_batting_average": "AVG",
    "fg_on_base_pct": "OBP",
    "fg_slugging_pct": "SLG",
    "fg_iso": "ISO",
    "fg_babip": "BABIP",
    "fg_walk_rate": "BB%",
    "fg_strikeout_rate": "K%",
    "fg_swinging_strike_rate": "SwStr%",
    "fg_contact_rate": "Contact%",
    "fg_zone_rate": "Zone%",
    "fg_pull_rate": "Pull%",
    "fg_center_rate": "Cent%",
    "fg_oppo_rate": "Oppo%",
    "fg_hard_pct": "Hard%",
    "fg_barrel_rate": "Barrel%",
    "fg_hard_hit_rate": "HardHit%",
    "fg_avg_exit_velocity": "EV (mph)",
    "fg_avg_launch_angle": "LA (°)",
    "fg_expected_batting_average": "xBA",
    "fg_clutch_score": "Clutch",
    "fg_win_probability_added": "WPA",
    "fg_games": "G",
    "fg_at_bats": "AB",
    "fg_plate_appearances": "PA",
    "fg_hits": "H",
    "fg_home_runs": "HR",
    "fg_runs_scored": "R",
    "fg_runs_batted_in": "RBI",
    "fg_walks": "BB",
    "fg_strikeouts": "SO",
    "fg_hit_by_pitch": "HBP",
    "fg_stolen_bases": "SB",
    "fg_barrels_count": "Barrels",
    "fg_hard_hit_count": "HardHit",
    "fg_risp_batting_average": "AVG (RISP)",
    "fg_risp_batting_average_calc": "AVG (RISP, H/AB)",
    "fg_hits_at_risp": "H (RISP)",
    "fg_home_runs_at_risp": "HR (RISP)",
    "fg_at_bats_at_risp": "AB (RISP)",
    "fg_slugging_pct_at_risp": "SLG (RISP)",
    # batter_by_inning / pitch_type
    "inning_avg": "AVG (by Inning)",
    "inning_ops": "OPS (by Inning)",
    "inning_hard_hit_rate": "HardHit% (by Inning)",
    "inning_batting_average": "AVG (by Inning, H/AB)",
    "early_inning_avg": "AVG (1-3回)",
    "late_inning_avg": "AVG (7+回)",
    "pitch_type_avg": "AVG (by Pitch Type)",
    "pitch_type_ops": "OPS (by Pitch Type)",
    "pitch_type_swinging_strike_rate": "SwStr% (by Pitch Type)",
    "pitch_type_hard_hit_rate": "HardHit% (by Pitch Type)",
    "vs_fastball_avg": "AVG vs FF",
    "vs_slider_avg": "AVG vs SL",
    "vs_changeup_ops": "OPS vs CH",
    # 次元用（columns に含まれた場合に整形）
    "season": "Season",
    "season_year": "Season",
    "player": "MLB ID",
    "player_name": "Player",
    "team": "Team",
    "metric_time__year": "Year",
}
...
def query_semantic_metrics_tool(
    ...
    if output_format == "table":
        return {
            ...
            "isTable": True,
            "tableData": rows,
            "columns": [{"key": c, "label": _SEMANTIC_METRIC_DISPLAY_NAMES.get(c, c.replace("_", " ").title())} for c in columns],
