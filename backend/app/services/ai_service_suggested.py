...
# from .bigquery_service import get_bq_client
...
# # =============================================================================
# # === Q&Aフローのためのヘルパー関数 (Batting Leaderboard特化版) ===
# # =============================================================================
...
# def _build_batting_leaderboard_sql(params: Dict[str, Any]) -> Optional[str]:
#     """
#     [ステップ2] "打撃リーダーボード"用のBigQuery SQLを構築します。
#     """
...
#     default_cols = ["player_name", "team", "season"]
...
# # =============================================================================
# # === メインQ&A関数 (Batting Leaderboard特化版) ===
# # =============================================================================
...
#     """
#     logger.info(f"Received Batting Leaderboard query: '{query}', season: {season}")
...
#     if not sql_query:
#         logger.warning("Failed to build SQL query from parameters.")
#         return "この質問に対応するデータの検索クエリを構築できませんでした。"
#     logger.info(f"Generated SQL query:\n{sql_query}")

#     # ステップ3: BigQueryからデータを取得
#     try:
