...
DIM_PLAYERS_MASTER_TABLE_ID = settings.bigquery_dim_players_master_table_id
PITCHING_STATS_MASTER_TABLE_ID = settings.bigquery_pitching_stats_master_table_id
STATCAST_MASTER_TABLE_ID = settings.bigquery_statcast_master_table_id
PITCH_PERFORMANCE_XBA_WHIFF_TABLE_ID = settings.bigquery_pitch_performance_xba_whiff_table_id
BATTER_HIT_LOC_QUALITY_TABLE_ID = settings.bigquery_batter_hit_loc_quality_table_id
PITCH_WHIFF_HEATMAP_TABLE_ID = settings.bigquery_pitch_whiff_heatmap_table_id
BATTER_COUNT_STATE_WOBA_TABLE_ID = settings.bigquery_batter_count_state_woba_table_id
BATTER_XWOBA_ZONE_TABLE_ID = settings.bigquery_batter_xwoba_zone_table_id
MART_BATTER_CLUTCH_TABLE_ID = settings.bigquery_mart_batter_clutch_table_id
MART_BATTER_SEASON_STATS_TABLE_ID = settings.bigquery_mart_batter_season_stats_table_id
...
MART_PITCHER_SEASON_STATS_TABLE_ID = settings.bigquery_mart_pitcher_season_stats_table_id
