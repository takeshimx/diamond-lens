...
class Settings(BaseSettings):
    ...
    bigquery_pitch_performance_xba_whiff_table_id: str = "mart_pitch_performance_xba_whiff"
    bigquery_batter_hit_loc_quality_table_id: str = "mart_batter_performance_hit_loc_quality"
    bigquery_pitch_whiff_heatmap_table_id: str = "mart_pitch_performance_whiff_heatmap"
